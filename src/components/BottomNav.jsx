...
// Active tab derived from useLocation() internally — no prop required.
// CSS custom property --bottom-nav-height is defined in :root via main.jsx globalStyle.
// More sheet exposes: Photos, Inventory (Plants added in APP-a when route exists).
...
export default function BottomNav() {
  ...
  return (
    <>
      ...
      {/* More sheet — slides up above nav */}
      {showMore && (
        <div style={{
          position: 'fixed',
          ...
          <div style={{
            ...
            backgroundColor: P.border, margin: '0 auto 12px',
          }} />
          {MORE_ITEMS.map(item => (
            <Link
              key={item.to}
      ...
      >
          ...
          if (tab.highlight) {
            return (
              ...
              >
                ...
                <span style={{ fontSize: '0.62rem', color: active ? P.green : P.light, fontWeight: active ? 700 : 400, marginTop: 1 }}>
                  {tab.label}
                </span>
              </Link>
            )
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            cursor: 'pointer',
            color: (showMore || moreActive) ? P.green : P.light,
            padding: 0,
          }}
        >
