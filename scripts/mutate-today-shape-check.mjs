...
const KILLERS = [
  ...
  ['instrument', /VOID|clock is NOT pinned|harness clock is pinned to|ESCAPED the harness|Open-Meteo was NOT stubbed|fixture .* is unusable|raised ".*" while mounting|every one of \d+ measured boxes is 0px/],
