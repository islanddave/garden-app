...
const TEXT_RULES = [
  ...
  // V5-TODAYSHAPE-001 privacy sweep (2026-09-24). A dumped notes/source field can carry a person's
  // address; the public site shows one household address and nothing here needs any. Refused as a
  // class rather than allowlisted, because the fixtures have no reason to hold one at all.
  {
    id: 'email',
    re: /\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/g,
    why: 'an email address. Nothing on the Today page renders one; a fixture that carries one is carrying a person, not a layout.',
  },
]
