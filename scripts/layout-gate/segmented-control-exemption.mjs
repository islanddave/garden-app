...
// `minHeight: 40` — under T.tapMinHeight (44). The Seeds page renders two of them: the view switch
// ("My seeds · Saved seeds · Sow now") and My seeds' sort ("Name · Oldest · Newest"). A census that
...
export const SEGMENTED_CONTROL_GROUPS = Object.freeze(['seeds-view-switch', 'my-seeds-sort'])
