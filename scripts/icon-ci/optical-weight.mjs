...
if (update) {
  const out = { _doc: 'V4-ICON-001 optical-weight baselines (live-area ink-coverage %, resvg). Regenerate with --update only after an APPROVED design change.', tolerance: 1.5, opticalExceptions: ['care.pause', 'nav.back', 'media.pause', 'media.play', 'media.stop', 'status.failed', 'status.dead', 'status.ended', 'severity.low', 'nav.more', 'care.sun', 'nav.critters', 'lifecycle.sprout', 'lifecycle.bud', 'lifecycle.bloom', 'lifecycle.fruit'], glyphs: measured }
