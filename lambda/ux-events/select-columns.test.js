// OPS-L081COLS-001 — static SELECT-column contract for ux-events.
//
...
//
// ux_events is the UX telemetry sink.
//
// The list below is EVIDENCE-DERIVED: the intersection of ux_events's live prod columns with the
...
describe('ux-events SELECT-column contract (L-081 Phase 1)', () => {
  it('declares exactly one audit table, so the auditor cross-product stays honest', () => {
    expect(AUDIT_TABLES).toEqual(['ux_events']);
  });
