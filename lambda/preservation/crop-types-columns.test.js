// OPS-SCHEMAAUDITJOIN-001 — the public.crop_types columns lambda/preservation reads.
//
// Four statements in index.js, all of them the same two-column label join — the narrowest
// crop_types contract in the repo. Worth noticing that none of the four filters deleted_at:
// a preservation record keeps naming its crop type after that type is soft-deleted, which is
// correct for a historical log and is why deleted_at is absent from this list rather than
// missing from it.
//
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/preservation crop_types column contract', () => {
