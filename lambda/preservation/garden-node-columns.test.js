// OPS-SCHEMAAUDITJOIN-001 — the public.garden_node columns lambda/preservation reads.
//
// Preservation resolves the source planting for a batch, including its succession position
// (`succession_group_id` / `succession_order`) — columns no other consumer in this audit touches,
// so nothing else would catch them going missing.
//
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/preservation garden_node column contract', () => {
