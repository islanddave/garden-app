// OPS-SCHEMAAUDITJOIN-001 — the public.garden_node columns lambda/tags reads.
//
// Four statements, all through `gn`, resolving tag targets back to their planting for household
// ownership and cultivar rollup. No display column is read here — the tag surface renders from the
// tag side, so this contract is deliberately narrower than the dashboard's.
//
...
const AUDIT_COLUMNS = {
  garden_node: ['archived_at', 'container_id', 'created_by', 'cultivar_id', 'deleted_at', 'id'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/tags garden_node column contract', () => {
