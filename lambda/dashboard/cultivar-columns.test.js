...
const AUDIT_COLUMNS = {
  cultivar: ['care_notes', 'crop_type_slug', 'deleted_at', 'display_name', 'genus', 'id', 'lifecycle', 'soil_notes', 'species'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/dashboard cultivar column contract', () => {
