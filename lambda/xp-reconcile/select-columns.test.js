// OPS-L081COLS-001 — static SELECT-column contract for xp-reconcile.
//
...
//
// xp-reconcile repairs user_stats drift — the very metric integrity-weekly-check watches.
//
...
describe('xp-reconcile SELECT-column contract (L-081 Phase 1)', () => {
