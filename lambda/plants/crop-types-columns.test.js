// OPS-SCHEMAAUDITJOIN-001 — the public.crop_types columns lambda/plants reads.
//
// Four statements in index.js, and the only directory here that reads default_unit while
// never reading display_name: a planting resolves its crop type to inherit harvest defaults,
// not to render a label. The label it shows comes from the variety.
//
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/plants crop_types column contract', () => {
