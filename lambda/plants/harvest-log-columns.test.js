// OPS-SCHEMAAUDITJOIN-001 — the public.harvest_log columns lambda/plants reads.
//
...
const AUDIT_COLUMNS = {
  harvest_log: ['deleted_at', 'event_id', 'updated_at'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/plants harvest_log column contract', () => {
