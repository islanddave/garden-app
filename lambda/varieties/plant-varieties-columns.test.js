// OPS-SCHEMAAUDITJOIN-001 — the public.plant_varieties columns lambda/varieties reads.
//
// Two statements, both unaliased and both in crop-derive.js, so both are pinned by hand
// below. They are the ten signals the crop-type deriver reads off a cultivar — genus,
// species, lifecycle, growth_habit, determinacy, day_length_response, scoville_max — to
// decide which crop_type_slug it belongs to. The file is byte-identical to
// tags/crop-derive.js. Note index.js does NOT appear here: it reads the cultivar VIEW, which
// carries its own contract in varieties/select-columns.test.js.
//
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/varieties plant_varieties column contract', () => {
