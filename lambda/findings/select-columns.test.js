// OPS-L081COLS-001 — static SELECT-column contract for findings.
//
...
//
// findings reads event_log to build the findings feed.
//
...
describe('findings SELECT-column contract (L-081 Phase 1)', () => {
