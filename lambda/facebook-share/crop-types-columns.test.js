// OPS-SCHEMAAUDITJOIN-001 — the public.crop_types columns lambda/facebook-share reads.
//
// Two statements in index.js, both label lookups: the crop name that goes into the post copy.
// Three columns, and no cadence or unit reads at all — this Lambda formats, it does not plan.
//
...
const AUDIT_COLUMNS = {
  crop_types: ['deleted_at', 'display_name', 'slug'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/facebook-share crop_types column contract', () => {
