// OPS-SCHEMAAUDITJOIN-001 — the public.event_log columns lambda/facebook-share reads.
//
// The share composer resolves the event behind a post. Four columns, and the one that
// matters is event_type: it selects which caption template renders, so a rename here changes what
// gets published to a public Page rather than merely erroring.
//
...
const AUDIT_COLUMNS = {
  event_log: ['deleted_at', 'event_type', 'id', 'plant_id'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/facebook-share event_log column contract', () => {
