// OPS-SCHEMAAUDITJOIN-001 — the public.garden_node columns lambda/facebook-share reads.
//
// One statement pair behind the share composer, resolving a planting's display name and cultivar
// for the caption. Small surface, but it is the caption text users see, and a missing column 500s
// the share rather than degrading it.
//
...
const AUDIT_COLUMNS = {
  garden_node: ['cultivar_id', 'deleted_at', 'display_name', 'id'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/facebook-share garden_node column contract', () => {
