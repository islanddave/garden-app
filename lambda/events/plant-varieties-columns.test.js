// OPS-SCHEMAAUDITJOIN-001 — the public.plant_varieties columns lambda/events reads.
//
// One statement in index.js: the ready-to-pick projection resolves a planting's variety only
// far enough to reach its crop type (plants.variety_id -> plant_varieties.crop_type_slug ->
// crop_types.slug). Three columns, no label read — the display name in that feed comes from
// crop_types, not from here.
//
...
const AUDIT_COLUMNS = {
  plant_varieties: ['crop_type_slug', 'deleted_at', 'id'],
};
