// OPS-SCHEMAAUDITJOIN-001 — the public.garden_node columns lambda/harvests reads.
//
// Two handlers. watch-route.js reaches the widest set — it derives the harvest-watch window from
// the planting's own lifecycle dates (sown_at / transplanted_at / planted_out_at), so those three
// are load-bearing for what the watch surfaces, not incidental.
//
...
const AUDIT_COLUMNS = {
  garden_node: [
    ...
    'featured_photo_id', 'id', 'location_id', 'planted_out_at', 'sown_at', 'status',
    'transplanted_at'
  ],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/harvests garden_node column contract', () => {
