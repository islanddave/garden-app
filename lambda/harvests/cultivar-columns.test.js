...
const AUDIT_COLUMNS = {
  cultivar: ['crop_type_slug', 'days_to_maturity_max', 'days_to_maturity_min', 'deleted_at', 'display_name', 'dtm_basis', 'id'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/harvests cultivar column contract', () => {
