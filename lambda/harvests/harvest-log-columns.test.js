// OPS-SCHEMAAUDITJOIN-001 — the public.harvest_log columns lambda/harvests reads.
//
...
const AUDIT_COLUMNS = {
  harvest_log: ['deleted_at', 'event_id', 'id', 'quality_rating', 'quantity', 'unit', 'weight_basis', 'weight_estimated', 'weight_grams'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/harvests harvest_log column contract', () => {
