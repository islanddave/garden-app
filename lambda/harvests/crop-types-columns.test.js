// OPS-SCHEMAAUDITJOIN-001 — the public.crop_types columns lambda/harvests reads.
//
// Three statements. Two in index.js are label lookups for the harvest list; the third is
// watch-route.js, the ready-to-pick watch, and it is the only reader in this directory of
// dtm_basis and set_to_first_pick_days — the two columns that decide when a first pick is
// expected, and therefore whether a planting appears on the watch at all.
//
...
const AUDIT_COLUMNS = {
  crop_types: ['deleted_at', 'display_name', 'dtm_basis', 'harvest_habit', 'set_to_first_pick_days', 'slug'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/harvests crop_types column contract', () => {
