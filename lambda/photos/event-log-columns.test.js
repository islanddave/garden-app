// OPS-SCHEMAAUDITJOIN-001 — the public.event_log columns lambda/photos reads.
//
...
//
// index.js and photoDelete.js add no columns beyond those five — they join event_log only to walk
// the photo/event link, never to read event content.
//
...
const AUDIT_COLUMNS = {
  event_log: ['created_by', 'deleted_at', 'id', 'plant_id', 'project_id'],
};
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/photos event_log column contract', () => {
