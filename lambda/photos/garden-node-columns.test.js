// OPS-SCHEMAAUDITJOIN-001 — the public.garden_node columns lambda/photos reads.
//
// Photos joins garden_node only to resolve a planting's container and to test archived state
// (`gna` / `gne` are the archived-ancestor probes). It never reads a display column from this
// table, which is why the contract is four columns for five statements.
//
...
describe('OPS-SCHEMAAUDITJOIN-001 — lambda/photos garden_node column contract', () => {
