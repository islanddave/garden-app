...
--   (bee_balm WAS on this list. V4-HARVHABITGAP-001, 2026-08-18: its pre-authored condition — "flip
--    to cut_and_come_again/14d if Dave actually picks it" — fired, so it is seeded below. Its
--    loss_horizon_hours stays NULL: that condition named a habit and a cadence and nothing more.)
...
WITH seed(slug, harvest_habit, repeat_interval_days, loss_horizon_hours,
  ...
  ('bee_balm','cut_and_come_again',14,NULL,NULL,NULL,NULL),  -- high | V4-HARVHABITGAP-001: executes the pre-authored flip condition (see the JSON)...
