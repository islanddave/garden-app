-- 0r-rollback.sql
-- BUG-INVREFSTRAND-001 — disarm the standing inventory-reference guard.
--
...
--
-- WHAT THIS DOES NOT UNDO, and must not: any strand you RESOLVED while the guard was armed. A
-- restored deleted_at or a detached pointer is a data decision recorded in the row itself, not an
-- artifact of this migration, and reversing it here would silently discard a judgement.
--
...
DELETE FROM public.schema_version WHERE version = '5.0.0-invrefstrand-20260908';
