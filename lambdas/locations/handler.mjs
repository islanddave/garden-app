...
export const handler = async (event) => {
  ...
  try {
    ...
    // TODO DB-MIGRATE-2: implement full CRUD for locations
    // Reference: projects/handler.mjs for route structure
    // Tables: public.locations (verify exact table name vs entity name)

    return err(501, 'locations handler not yet implemented');
