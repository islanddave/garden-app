...
export const handler = async (event) => {
  ...
  try {
    ...
    // TODO DB-MIGRATE-2: implement full CRUD for events
    // Reference: projects/handler.mjs for route structure
    // Tables: public.events (verify exact table name vs entity name)

    return err(501, 'events handler not yet implemented');
