...
export const handler = async (event) => {
  ...
  try {
    ...
    // TODO DB-MIGRATE-2: implement full CRUD for photos
    // Reference: projects/handler.mjs for route structure
    // Tables: public.photos (verify exact table name vs entity name)

    return err(501, 'photos handler not yet implemented');
