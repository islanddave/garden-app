...
export const handler = async (event) => {
  ...
  try {
    ...
    // TODO DB-MIGRATE-2: implement full CRUD for plants
    // Reference: projects/handler.mjs for route structure
    // Tables: public.plants (verify exact table name vs entity name)

    return err(501, 'plants handler not yet implemented');
