...
export const handler = async (event) => {
  ...
  try {
    ...
    // TODO DB-MIGRATE-2: implement full CRUD for favorites
    // Reference: projects/handler.mjs for route structure
    // Tables: public.favorites (verify exact table name vs entity name)

    return err(501, 'favorites handler not yet implemented');
